...
root = Tk()
root.title("Επιλογη προγραμματος")
...
def Epilogh2():
    ...
    import random
    my_list = ["True","False"]
    download = random.choice(my_list)
    print(download)



my_Button1 = Button(root,text = "Επιλογη 1",padx = 40 , pady = 40 , fg = "green",bg = "black" , command = Epilogh1)
my_Button2 = Button(root,text = "Επιλογη 2",padx = 40 , pady = 40 , fg = "blue" , bg = "yellow" , command = Epilogh2)

my_Button1.grid(row = 0, column = 0)
my_Button2.grid(row = 0, column = 10)
